...
// func __istype(_c C__darwin_ct_rune_t, _f uint32) uint32 {
//     if isascii(int(_c)) != 0 {
...
// func __isctype(_c C__darwin_ct_rune_t, _f uint32) C__darwin_ct_rune_t {
//     if _c < 0 || _c >= (1 <<8 ) {
//         return 0
//     }

//     return C__darwin_ct_rune_t(__not_uint32(__not_uint32((_DefaultRuneLocale.__runetype[_c] & _f))))
// }

func __tolower(c C__darwin_ct_rune_t) C__darwin_ct_rune_t {
    return C__darwin_ct_rune_t(unicode.ToLower(rune(c)))
}

func __toupper(c C__darwin_ct_rune_t) C__darwin_ct_rune_t {
    return C__darwin_ct_rune_t(unicode.ToUpper(rune(c)))
}
